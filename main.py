''' mongo query and fetching data by one slm '''
...
#         messages=[
#             {"role": "system",
#             "content": "You are a helpful assistant that summarizes MongoDB query results, Always answer strictly in JSON without SQL or explanations."
#             },
#             {"role": "user",
#             "content": f"Here are some documents:\n{docs_text}\n\nExtract and summarize the key details clearly in JSON."
#             }
#         ],
#         temperature=0.5,
#         max_tokens=300
